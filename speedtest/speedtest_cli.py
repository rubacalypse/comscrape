...
def speedtest():
    ...
    if not args.simple:
        ...
        #print "CONFIG WHAT HAHA: %s" % config['client']['ip']
        output['isp'] = config['client']['isp']
        output['ip'] = config['client']['ip']
    ...
    output['latency'] = best['latency']
    #print "BLAORPSDFA %s" % output['latency']
    ...
    #print "DOWNLOAD VAL: %0.2f" % ((dlspeed / 1000 / 1000) * 8)
    #dlMb = round(((dlspeed / 1000 / 1000) * 8), 2)
    #output['download'] = dlMb
    output['download'] = dlspeed
    ...
    #ulMb = round(((ulspeed / 1000 / 1000) * 8), 2)
    output['upload'] = ulspeed
    #output['upload'] = ulMb
